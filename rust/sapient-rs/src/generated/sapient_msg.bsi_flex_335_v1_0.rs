...
pub struct RangeBearingCone {
    ...
    pub range_error: ::core::option::Option<f64>,
    /// Units used by the range bearing
    #[prost(enumeration = "RangeBearingCoordinateSystem", tag = "11")]
    pub coordinate_system: i32,
    /// Datum or 'north' used by the range bearing
    #[prost(enumeration = "RangeBearingDatum", tag = "12")]
    pub datum: i32,
}
#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
#[repr(i32)]
...
pub struct AlertAck {
    ...
    pub alert_id: ::prost::alloc::string::String,
    /// State of the information in this message
    #[prost(enumeration = "alert_ack::AlertStatus", tag = "2")]
    pub alert_status: i32,
...
pub mod alert_ack {
    ...
    impl AlertStatus {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Self::Unspecified => "ALERT_STATUS_UNSPECIFIED",
                Self::Accepted => "ALERT_STATUS_ACCEPTED",
                Self::Rejected => "ALERT_STATUS_REJECTED",
                Self::Cancelled => "ALERT_STATUS_CANCELLED",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                "ALERT_STATUS_UNSPECIFIED" => Some(Self::Unspecified),
                "ALERT_STATUS_ACCEPTED" => Some(Self::Accepted),
                "ALERT_STATUS_REJECTED" => Some(Self::Rejected),
                "ALERT_STATUS_CANCELLED" => Some(Self::Cancelled),
                _ => None,
            }
        }
    }
...
pub struct EnuVelocityUnits {
    ...
    #[prost(enumeration = "SpeedUnits", tag = "1")]
...
pub struct Registration {
    ...
    #[prost(string, tag = "2")]
    pub icd_version: ::prost::alloc::string::String,
    /// System name
    #[prost(string, optional, tag = "3")]
...
pub mod registration {
    ...
    pub struct ModeDefinition {
        /// Mode's name
        #[prost(string, tag = "1")]
        pub mode_name: ::prost::alloc::string::String,
        /// Mode's type
        ...
        pub detection_definition: ::core::option::Option<DetectionDefinition>,
        /// Definition of tasks that can be accepted by the ASM while in this mode
        #[prost(message, repeated, tag = "11")]
        pub task: ::prost::alloc::vec::Vec<TaskDefinition>,
    }
    #[derive(Clone, PartialEq, ::prost::Message)]
    ...
    pub struct PerformanceValue {
        ...
        #[prost(string, tag = "3")]
        pub unit_value: ::prost::alloc::string::String,
...
pub struct RegistrationAck {
    ...
    #[prost(string, optional, tag = "2")]
    pub ack_response_reason: ::core::option::Option<::prost::alloc::string::String>,
}
/// \[START messages\]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct StatusReport {
    ...
    pub report_id: ::prost::alloc::string::String,
    /// Current ASM status
    #[prost(enumeration = "status_report::System", tag = "2")]
    pub system: i32,
    /// State of the information in this message
    #[prost(enumeration = "status_report::Info", tag = "3")]
    pub info: i32,
    /// ULID of the task the ASM is currently performing
    #[prost(string, optional, tag = "4")]
    ...
    #[prost(message, optional, tag = "8")]
    pub field_of_view: ::core::option::Option<status_report::LocationOrRangeBearing>,
    /// Area that the ASM can cover
    #[prost(message, optional, tag = "9")]
    pub coverage: ::core::option::Option<status_report::LocationOrRangeBearing>,
    /// Area that the ASM cannot cover
    #[prost(message, repeated, tag = "10")]
    pub obscuration: ::prost::alloc::vec::Vec<status_report::LocationOrRangeBearing>,
...
pub mod status_report {
    ...
    pub mod location_or_range_bearing {
        ...
        pub enum FovOneof {
            ...
            #[prost(message, tag = "1")]
            RangeBearing(super::super::RangeBearingCone),
            /// Location in Geo coordinates
            #[prost(message, tag = "2")]
            LocationList(super::super::LocationList),
        }
    }
    #[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
    pub struct Status {
    ...
    impl StatusLevel {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::SensorStatus => "STATUS_LEVEL_SENSOR_STATUS",
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "STATUS_LEVEL_SENSOR_STATUS" => Some(Self::SensorStatus),
...
pub struct Task {
    ...
    #[prost(enumeration = "task::Control", tag = "6")]
    pub control: i32,
...
pub mod task {
    ...
    pub mod command {
        ...
        pub enum Command {
            ...
            /// LookAt command for tasking pointing ASMs
            #[prost(message, tag = "6")]
            LookAt(super::LocationOrRangeBearing),
        }
    }
    #[derive(Clone, PartialEq, ::prost::Message)]
    pub struct Region {
        ...
        #[prost(message, optional, tag = "4")]
        pub region_area: ::core::option::Option<LocationOrRangeBearing>,
    ...
    pub struct SubClassFilter {
        ...
        pub sub_class_filter: ::prost::alloc::vec::Vec<SubClassFilter>,
        /// Priority of filter
        #[prost(enumeration = "DiscreteThreshold", tag = "4")]
        pub priority: i32,
    }
    #[derive(Clone, PartialEq, ::prost::Message)]
    ...
    impl Control {
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "CONTROL_DEFAULT" => Some(Self::Default),
                _ => None,
            }
        }
    }
    ...
    impl Operator {
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "OPERATOR_GREATER_THAN" => Some(Self::GreaterThan),
                "OPERATOR_LESS_THAN" => Some(Self::LessThan),
                "OPERATOR_EQUALS" => Some(Self::Equals),
                _ => None,
            }
        }
    }
